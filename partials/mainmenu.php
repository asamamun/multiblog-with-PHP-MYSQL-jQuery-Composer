				...
				<div id="nav-fixed">
					<div class="container">
						...
						<ul class="nav-menu nav navbar-nav">
							...
							if(!Session::user()){
								?>
							<li class="cat-1"><a href="signup.php">SignUp</a></li>
							<li class="cat-2"><a href="login.php">LogIn</a></li>
							<?php								
							}
							else{
								?>
								<li class="cat-2"><a href="create.php">New</a></li>
							<li><a href="#"><?php echo "Hi, ".$_SESSION['username']; ?></a></li>
								
							<li class="cat-1"><a href="logout.php">Logout</a></li>	
								<?php
							}
							?>
